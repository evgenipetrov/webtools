...
EXPORT_SUBFOLDER = "googlesearchconsole_page_last_1m_export"


class GoogleSearchConsolePageExportLast1m(BaseExportManager):
    ...
    def perform_export(self):
        ...
        csv_file_path = os.path.join(self.export_path, "googlesearchconsole_page_last_1m_export.csv")
