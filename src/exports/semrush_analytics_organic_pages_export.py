...
class SemrushAnalyticsOrganicPagesExport(BaseExportManager):
    ...
    def perform_pre_export_action(self):
        """
        Provides instructions for Semrush organic pages export in a step-by-step format.
        """
        ...
        print(f"{color_yellow}Please follow these steps for Semrush organic pages export:{color_reset}")
