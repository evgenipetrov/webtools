...
EXPORT_SUBFOLDER = "googlesearchconsole_page_query_last_1m_export"


class GoogleSearchConsolePageQueryExportLast1m(BaseExportManager):
    ...
    def perform_export(self):
        ...
        csv_file_path = os.path.join(self.export_path, "gsc_last_1m_page_query_export.csv")
