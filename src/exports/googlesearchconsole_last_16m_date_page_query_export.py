...
EXPORT_SUBFOLDER = "googlesearchconsole_last_16m_date_page_query_export"


class GoogleSearchConsoleLast16mDatePageQueryExport(BaseExportManager):
    ...
    def perform_export(self):
        ...
        csv_file_path = os.path.join(self.export_path, "gsc_last_16m_date_page_query_export.csv")
