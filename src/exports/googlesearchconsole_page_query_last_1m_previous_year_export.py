...
# Export Variables
EXPORT_SUBFOLDER = "googlesearchconsole_page_query_last_1m_previous_year_export"
EXPORT_FILENAME = EXPORT_SUBFOLDER + ".csv"
BASE_DATE = datetime.date.today() - relativedelta(days=5)
START_DATE = BASE_DATE - relativedelta(months=13)
END_DATE = BASE_DATE - relativedelta(months=12)


class GoogleSearchConsolePageQueryLast1mPreviousYearExport(BaseExportManager):
